        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form class="format-style">
                    ...
                    <!-- add form -->
                    <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4">Address</div>
                        <div class="col-xs-8 col-sm-8 col-md-8">
                            <div class="form-group">
                    ...
                    <!-- add form -->
                    <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4">Contact number</div>
                    <div class="col-xs-8 col-sm-8 col-md-8">
                        <div class="form-group">
                        <input type="contact" class="form-control" id="contact" placeholder="contact number">
                        </div>
                    </div>
                    </div>
                    <!-- add form -->
                    <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4">Nationality</div>
                    <div class="col-xs-8 col-sm-8 col-md-8">
                        <div class="form-group">
                        <input type="nation" class="form-control" id="nation" placeholder="Nationality">
                        </div>
                    </div>
                    </div>
                    <!-- add form -->
                    <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4">Email address</div>
                    <div class="col-xs-8 col-sm-8 col-md-8">
                        <div class="form-group">
                    ...
                    <div class="button-holder">
                        <a href="3rd-page.php" class="btn btn-start">NEXT</a>
                    </div>
                    </div>
                </form>
                </div>
